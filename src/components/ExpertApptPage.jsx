            ...
            <React.Fragment>
              {!this.state.displayslots ? (
                ...
                <div className="table-container">
                  <div className="table">
                    {this.state.slots
                      .filter((slot) => time1 < slot.slice(0, 5))
                      .map((slot) => (
                        <button
                          value={slot}
                          className="time-slots"
                          onClick={(e) => this.handleSlots(e)}
                        >
                          {" "}
                          {slot}{" "}
                        </button>
                  ...
                  <button onClick={this.handleReschedule}>CONFIRM</button>
                </div>
              )}
            </React.Fragment>
          ) : (
            <h2>Hello! Your appointment is rescheduled</h2>
          )}
        </div>
